// ======================================================================
// MuflaGLCD.v generated from TopDesign.cysch
// 02/17/2021 at 16:07
...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("1fe61c3b-3270-43fa-99a9-77566c7a6527/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
// ADC_DelSig_v3_30(ADC_Alignment=0, ADC_Alignment_Config2=0, ADC_Alignment_Config3=0, ADC_Alignment_Config4=0, ADC_Charge_Pump_Clock=false, ADC_Clock=1, ADC_CLOCK_FREQUENCY=128000, ADC_Input_Mode=0, ADC_Input_Range=4, ADC_Input_Range_Config2=10, ADC_Input_Range_Config3=4, ADC_Input_Range_Config4=4, ADC_Power=1, ADC_Reference=0, ADC_Reference_Config2=0, ADC_Reference_Config3=0, ADC_Reference_Config4=0, ADC_Resolution=16, ADC_Resolution_Config2=20, ADC_Resolution_Config3=16, ADC_Resolution_Config4=16, Clock_Frequency=64000, Comment_Config1=Default Config, Comment_Config2=Second Config, Comment_Config3=Third Config, Comment_Config4=Fourth Config, Config1_Name=IC_Config, Config2_Name=TC_Config, Config3_Name=Therm_Config, Config4_Name=CFG4, Configs=3, Conversion_Mode=2, Conversion_Mode_Config2=2, Conversion_Mode_Config3=2, Conversion_Mode_Config4=2, Enable_Vref_Vss=false, EnableModulatorInput=false, Input_Buffer_Gain=1, Input_Buffer_Gain_Config2=1, Input_Buffer_Gain_Config3=1, Input_Buffer_Gain_Config4=1, Input_Buffer_Mode=2, Input_Buffer_Mode_Config2=2, Input_Buffer_Mode_Config3=2, Input_Buffer_Mode_Config4=1, Ref_Voltage=1.024, Ref_Voltage_Config2=1.024, Ref_Voltage_Config3=1.024, Ref_Voltage_Config4=1.024, rm_int=false, Sample_Rate=2000, Sample_Rate_Config2=60, Sample_Rate_Config3=10000, Sample_Rate_Config4=10000, Start_of_Conversion=0, Vdda_Value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_DelSig_v3_30, CY_CONFIG_TITLE=ADC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=ADC, )
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("a3104b34-bde2-4d85-8f1a-44953581d801/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a3104b34-bde2-4d85-8f1a-44953581d801/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module ADC_SAR_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("13bc90d9-bd09-4e02-b8a4-4074714107ba/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Tpos_net;
	wire [0:0] tmpFB_0__Tpos_net;
	wire [0:0] tmpIO_0__Tpos_net;
	wire [0:0] tmpINTERRUPT_0__Tpos_net;
	electrical [0:0] tmpSIOVREF__Tpos_net;
	...
	cy_psoc3_pins_v1_10
		...
		Tpos
		 (.oe(tmpOE__Tpos_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Tpos_net[0:0]}),
		  .analog({Net_871}),
		  .io({tmpIO_0__Tpos_net[0:0]}),
		  .siovref(tmpSIOVREF__Tpos_net),
		  .interrupt({tmpINTERRUPT_0__Tpos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tpos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Tneg_net;
	wire [0:0] tmpFB_0__Tneg_net;
	wire [0:0] tmpIO_0__Tneg_net;
	wire [0:0] tmpINTERRUPT_0__Tneg_net;
	electrical [0:0] tmpSIOVREF__Tneg_net;
	...
	cy_psoc3_pins_v1_10
		...
		Tneg
		 (.oe(tmpOE__Tneg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Tneg_net[0:0]}),
		  .analog({Net_870}),
		  .io({tmpIO_0__Tneg_net[0:0]}),
		  .siovref(tmpSIOVREF__Tneg_net),
		  .interrupt({tmpINTERRUPT_0__Tneg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tneg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_1 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_667),
        .tx_interrupt(Net_668),
        .rx_interrupt(Net_669),
        .tx_data(Net_670),
        .tx_clk(Net_671),
        .rx_data(Net_672),
        .rx_clk(Net_673));
	...
	wire [0:0] tmpOE__VENT1_net;
	wire [0:0] tmpFB_0__VENT1_net;
	wire [0:0] tmpIO_0__VENT1_net;
	wire [0:0] tmpINTERRUPT_0__VENT1_net;
	electrical [0:0] tmpSIOVREF__VENT1_net;
	...
	cy_psoc3_pins_v1_10
		...
		VENT1
		 (.oe(tmpOE__VENT1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VENT1_net[0:0]}),
		  .io({tmpIO_0__VENT1_net[0:0]}),
		  .siovref(tmpSIOVREF__VENT1_net),
		  .interrupt({tmpINTERRUPT_0__VENT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VENT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("07fae782-1d33-46d8-92f4-3dc2bde598b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63451a20-32a7-470f-a2a5-52f6f3d59928"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__D_I_net;
	wire [0:0] tmpFB_0__D_I_net;
	wire [0:0] tmpIO_0__D_I_net;
	wire [0:0] tmpINTERRUPT_0__D_I_net;
	electrical [0:0] tmpSIOVREF__D_I_net;

	cy_psoc3_pins_v1_10
		#(.id("f93831a9-3b47-42cb-aa78-70d5807bb253"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		D_I
		 (.oe(tmpOE__D_I_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__D_I_net[0:0]}),
		  .io({tmpIO_0__D_I_net[0:0]}),
		  .siovref(tmpSIOVREF__D_I_net),
		  .interrupt({tmpINTERRUPT_0__D_I_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D_I_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__R_W_net;
	wire [0:0] tmpFB_0__R_W_net;
	wire [0:0] tmpIO_0__R_W_net;
	wire [0:0] tmpINTERRUPT_0__R_W_net;
	electrical [0:0] tmpSIOVREF__R_W_net;

	cy_psoc3_pins_v1_10
		#(.id("589d99bd-082d-4e3a-a27b-54bc12c92cc9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		R_W
		 (.oe(tmpOE__R_W_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_W_net[0:0]}),
		  .io({tmpIO_0__R_W_net[0:0]}),
		  .siovref(tmpSIOVREF__R_W_net),
		  .interrupt({tmpINTERRUPT_0__R_W_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R_W_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b59b210d-2436-41b3-97c2-27bc332d5913"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4d17b3f6-c1d2-4cde-b86f-743230e762d8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LCD3_net;
	wire [0:0] tmpFB_0__LCD3_net;
	wire [0:0] tmpIO_0__LCD3_net;
	wire [0:0] tmpINTERRUPT_0__LCD3_net;
	electrical [0:0] tmpSIOVREF__LCD3_net;

	cy_psoc3_pins_v1_10
		#(.id("3019d5d7-c67a-40c7-adf6-dcae39ee26e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LCD3
		 (.oe(tmpOE__LCD3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD3_net[0:0]}),
		  .io({tmpIO_0__LCD3_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD3_net),
		  .interrupt({tmpINTERRUPT_0__LCD3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_0_net;
	wire [0:0] tmpFB_0__DB_0_net;
	wire [0:0] tmpIO_0__DB_0_net;
	wire [0:0] tmpINTERRUPT_0__DB_0_net;
	electrical [0:0] tmpSIOVREF__DB_0_net;

	cy_psoc3_pins_v1_10
		#(.id("f704ef6e-bc63-468c-af63-e3a7123ad0b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_0
		 (.oe(tmpOE__DB_0_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__DB_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_1_net;
	wire [0:0] tmpFB_0__DB_1_net;
	wire [0:0] tmpIO_0__DB_1_net;
	wire [0:0] tmpINTERRUPT_0__DB_1_net;
	electrical [0:0] tmpSIOVREF__DB_1_net;

	cy_psoc3_pins_v1_10
		#(.id("68b2fe7c-5082-4066-b338-125a7442799b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_1
		 (.oe(tmpOE__DB_1_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__DB_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_2_net;
	wire [0:0] tmpFB_0__DB_2_net;
	wire [0:0] tmpIO_0__DB_2_net;
	wire [0:0] tmpINTERRUPT_0__DB_2_net;
	electrical [0:0] tmpSIOVREF__DB_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d3889c5b-e701-4cb5-ae48-411e73b4f3e9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_2
		 (.oe(tmpOE__DB_2_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__DB_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_3_net;
	wire [0:0] tmpFB_0__DB_3_net;
	wire [0:0] tmpIO_0__DB_3_net;
	wire [0:0] tmpINTERRUPT_0__DB_3_net;
	electrical [0:0] tmpSIOVREF__DB_3_net;

	cy_psoc3_pins_v1_10
		#(.id("1fd24e4f-854e-4582-888b-27c70f95a99b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_3
		 (.oe(tmpOE__DB_3_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__DB_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_4_net;
	wire [0:0] tmpFB_0__DB_4_net;
	wire [0:0] tmpIO_0__DB_4_net;
	wire [0:0] tmpINTERRUPT_0__DB_4_net;
	electrical [0:0] tmpSIOVREF__DB_4_net;

	cy_psoc3_pins_v1_10
		#(.id("1cc1881f-0141-4da4-bfad-3b653eb0f2f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_4
		 (.oe(tmpOE__DB_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DB_4_net[0:0]}),
		  .io({tmpIO_0__DB_4_net[0:0]}),
		  .siovref(tmpSIOVREF__DB_4_net),
		  .interrupt({tmpINTERRUPT_0__DB_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_5_net;
	wire [0:0] tmpFB_0__DB_5_net;
	wire [0:0] tmpIO_0__DB_5_net;
	wire [0:0] tmpINTERRUPT_0__DB_5_net;
	electrical [0:0] tmpSIOVREF__DB_5_net;

	cy_psoc3_pins_v1_10
		#(.id("914d0dc1-5da7-494b-a62b-193611762741"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_5
		 (.oe(tmpOE__DB_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DB_5_net[0:0]}),
		  .io({tmpIO_0__DB_5_net[0:0]}),
		  .siovref(tmpSIOVREF__DB_5_net),
		  .interrupt({tmpINTERRUPT_0__DB_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_6_net;
	wire [0:0] tmpFB_0__DB_6_net;
	wire [0:0] tmpIO_0__DB_6_net;
	wire [0:0] tmpINTERRUPT_0__DB_6_net;
	electrical [0:0] tmpSIOVREF__DB_6_net;

	cy_psoc3_pins_v1_10
		#(.id("0f97ce46-0adb-459d-bce0-b78d9f16613e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_6
		 (.oe(tmpOE__DB_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DB_6_net[0:0]}),
		  .io({tmpIO_0__DB_6_net[0:0]}),
		  .siovref(tmpSIOVREF__DB_6_net),
		  .interrupt({tmpINTERRUPT_0__DB_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DB_7_net;
	wire [0:0] tmpFB_0__DB_7_net;
	wire [0:0] tmpIO_0__DB_7_net;
	wire [0:0] tmpINTERRUPT_0__DB_7_net;
	electrical [0:0] tmpSIOVREF__DB_7_net;

	cy_psoc3_pins_v1_10
		#(.id("742cbe51-6424-4682-850e-8b681641c3ca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DB_7
		 (.oe(tmpOE__DB_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DB_7_net[0:0]}),
		  .io({tmpIO_0__DB_7_net[0:0]}),
		  .siovref(tmpSIOVREF__DB_7_net),
		  .interrupt({tmpINTERRUPT_0__DB_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DB_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("23a7b038-13c5-434f-8c34-81ce14ba1918"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e9fc8a72-676c-4203-afb6-01137e41f1a1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f44cc877-7d60-46e2-9031-00b5be27aa01"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6735a55e-a3e0-4aa6-9392-c510b0c70db1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__VENT2_net;
	wire [0:0] tmpFB_0__VENT2_net;
	wire [0:0] tmpIO_0__VENT2_net;
	wire [0:0] tmpINTERRUPT_0__VENT2_net;
	electrical [0:0] tmpSIOVREF__VENT2_net;

	cy_psoc3_pins_v1_10
		#(.id("664670eb-0325-4751-8d04-dd5c88bcf806"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		VENT2
		 (.oe(tmpOE__VENT2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VENT2_net[0:0]}),
		  .io({tmpIO_0__VENT2_net[0:0]}),
		  .siovref(tmpSIOVREF__VENT2_net),
		  .interrupt({tmpINTERRUPT_0__VENT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VENT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
