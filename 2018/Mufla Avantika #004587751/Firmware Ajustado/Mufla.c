...
float V0=0.0,Tciclo=10.0,Tpulso=0.0,error=0.0,Prom=0.0,Temperature=0.0,tmp=0.0,Ganancia=3.0,desvio=3.0,Coeficiente=150.0,AlTem=20.0;
float Aumento=0.0,Temperatura=0.0,Pendiente=0.0,DifPendiente=0.0,Setpoint=0,Integral=0,Derivativo=0;
...
//-------------------------------Control de Calentamiento------------------------------------------------------------//         
   ...
   if(Pendiente==0){// Si Esta realizando una Meseta debe realizar el control JuDifuso
      ...
      PotenciaEntregada=((PendienteMinutos+DifPendiente)*100)/90;
