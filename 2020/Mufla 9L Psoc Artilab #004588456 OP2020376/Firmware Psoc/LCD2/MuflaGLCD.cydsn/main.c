...
short mensaje,Lectura2,flag_setpoint,flag_tiempocalentamiento,Lectura,flagup,flagdn,flagRampa,flag_calcula,finalizoCiclo;
...
{ 
    ...
    {   
        if(Lectura2){
            ...
            Lectura2=0;
            Temperatura=leeTermocupla(MediaMovil);
            if(!finalizoCiclo && Menu==20){
                VENT1_Write(0);                   
            }else if(Menu!=20){
                VENT1_Write(1);                   
            }else{
                if((Tempoc[0]>=Tempocp[0])&&(Tempoc[1]>=Tempocp[1])&&(Tempoc[2]>=Tempocp[2])&&(Tempoc[3]>=Tempocp[3])){
                    VENT1_Write(1);    
                }else{
                    VENT1_Write(0);                       
                }
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      if(Menu==1){ //Menu Principal.      
         ...
         if(Opcion<=5){
            ...
            if(Opcion==6)   
                {strcpy(Menus.Letra,"Tiempo Campana");
                displayMenu(Menus.Letra,0,18,1,1);}
            else
                {strcpy(Menus.Letra,"Tiempo Campana");
                displayMenu(Menus.Letra,0,18,0,1);}
