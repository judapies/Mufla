...
#define ADC_IC_Config_RESOLUTION         (16u )
#define ADC_IC_Config_INPUT_RANGE        (4u)
#define ADC_IC_Config_SRATE              (2000u)
#define ADC_IC_Config_REFERENCE          (0u)
#define ADC_IC_Config_BUFFER_GAIN        (1u)
#define ADC_IC_Config_CONV_MODE          (2u)
#define ADC_IC_Config_INPUT_RANGE_VALUE  (1.024)
#define ADC_DEFAULT_STROBE                     (0u)
#define ADC_DEFAULT_INTERNAL_CLK               (1u)
#define ADC_DEFAULT_NUM_CONFIGS                (3u)
...
*/
#define ADC_IC_Config                (1u)
#define ADC_TC_Config                (2u)
#define ADC_Therm_Config                (3u)
#define ADC_CFG4                (4u)
...
/* Default Config
* ADC_IC_Config Sample Rate: 2000 Samples per Second
* ADC_IC_Config Conversion Mode: 2
* ADC_IC_Config Input Buffer Gain: 1
* ADC_IC_Config Reference: 0
* ADC_IC_Config Input Range: 4
* ADC_IC_Config Resolution: 16 bits
* ADC_IC_Config Clock: 128000 Hz
*/

#define ADC_IC_Config_DEC_CR             (0x38u)
#define ADC_IC_Config_DEC_SR             (0x14u)
#define ADC_IC_Config_DEC_SHIFT1         (0x04u)
#define ADC_IC_Config_DEC_SHIFT2         (0x07u)
#define ADC_IC_Config_DEC_DIV            (0)
#define ADC_IC_Config_DEC_DR2            (0x00u)
#define ADC_IC_Config_DEC_DR2H           (0x00u)
#define ADC_IC_Config_DEC_DR1            (0x3Fu)
#define ADC_IC_Config_DEC_OCOR           (0x00u)
#define ADC_IC_Config_DEC_OCORM          (0x00u)
#define ADC_IC_Config_DEC_OCORH          (0x00u)
#define ADC_IC_Config_DEC_GVAL           (0x0Fu)
#define ADC_IC_Config_DEC_GCOR           (0x00u)
#define ADC_IC_Config_DEC_GCORH          (0x00u)
#define ADC_IC_Config_DEC_COHER          (0x01u)
#define ADC_IC_Config_DSM_CR0            (0x0Au)
#define ADC_IC_Config_DSM_CR1            (0x00u)
#define ADC_IC_Config_DSM_CR2            (0x7Au)
#define ADC_IC_Config_DSM_CR3            (0x00u)
#define ADC_IC_Config_DSM_CR4            (0x50u)
#define ADC_IC_Config_DSM_CR5            (0x27u)
#define ADC_IC_Config_DSM_CR6            (0x2Cu)
#define ADC_IC_Config_DSM_CR7            (0x00u)
#define ADC_IC_Config_DSM_CR8            (0x5Bu)
#define ADC_IC_Config_DSM_CR9            (0x5Eu)
#define ADC_IC_Config_DSM_CR10           (0x55u)
#define ADC_IC_Config_DSM_CR11           (0x5Au)
#define ADC_IC_Config_DSM_CR12           (0x05u)
#define ADC_IC_Config_DSM_CR13           (0x00u)
#define ADC_IC_Config_DSM_CR14           (0x00u)
#define ADC_IC_Config_DSM_CR15           (0x00u)
#define ADC_IC_Config_DSM_CR16           (0x0Au)
#define ADC_IC_Config_DSM_CR17           (0x43u)
#define ADC_IC_Config_DSM_REF0           (0x44u)
#define ADC_IC_Config_DSM_REF1           (0x00u)
#define ADC_IC_Config_DSM_REF2           (0x58u)
#define ADC_IC_Config_DSM_REF3           (0x00u)
#define ADC_IC_Config_DSM_DEM0           (0x04u)
#define ADC_IC_Config_DSM_DEM1           (0x00u)
#define ADC_IC_Config_DSM_MISC           (0x00u)
#define ADC_IC_Config_DSM_CLK            (0x18u)
#define ADC_IC_Config_DSM_BUF0           (0x01u)
#define ADC_IC_Config_DSM_BUF1           (0x01u)
#define ADC_IC_Config_DSM_BUF2           (0x00u)
#define ADC_IC_Config_DSM_BUF3           (0x0Au)
#define ADC_IC_Config_DSM_OUT0           (0x00u)
#define ADC_IC_Config_DSM_OUT1           (0x00u)
#define ADC_IC_Config_DSM_SW3            (0x00u)
#define ADC_IC_Config_CLOCKS_PER_SAMPLE  (0x0040u)
#define ADC_IC_Config_CLOCK_FREQ         (128000u)
#define ADC_IC_Config_CP_CLOCK_FREQ      (4000000u)
#define ADC_IC_Config_REFERENCE_VOLTAGE  (1.0240)
#define ADC_IC_Config_COUNTS_PER_VOLT    (32000)
#define ADC_IC_Config_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_IC_Config_IDEAL_ODDDEC_GAIN  (0x8000u)

#define ADC_IC_Config_ALIGNMENT          (0u)
#define ADC_IC_Config_ADC_CLK_DIVIDER    (186u)
#define ADC_IC_Config_CP_CLK_DIVIDER     (5u)

/* Input and DAC Cap values in pF */
#define ADC_IC_Config_IPCAP1VALUE        (0x0F30u)
#define ADC_IC_Config_DACAPVALUE         (0x1130u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_DEFAULT_SRATE                      ADC_IC_Config_SRATE
#define ADC_CLOCKS_PER_SAMPLE                  ADC_IC_Config_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ                    ADC_IC_Config_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE                  ADC_IC_Config_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT               ADC_IC_Config_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION                 ADC_IC_Config_RESOLUTION
#define ADC_DEFAULT_CONV_MODE                  ADC_IC_Config_CONV_MODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN             ADC_IC_Config_IDEAL_DEC_GAIN
#define ADC_DEFAULT_RANGE                      ADC_IC_Config_RANGE
#define ADC_DEFAULT_RANGE_VALUE                ADC_IC_Config_RANGE_VALUE
#define ADC_DEFAULT_REFERENCE                  ADC_IC_Config_REFERENCE
#define ADC_DEFAULT_BUF_GAIN                   ADC_IC_Config_BUF_GAIN
#define ADC_IC_Config_BUF_GAIN           ADC_IC_Config_BUFFER_GAIN
#define ADC_IC_Config_RANGE              ADC_IC_Config_INPUT_RANGE
#define ADC_IC_Config_RANGE_VALUE        ADC_IC_Config_INPUT_RANGE_VALUE

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE                ADC_IC_Config_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE                 ADC_IC_Config_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN          ADC_IC_Config_IDEAL_ODDDEC_GAIN


/* Default register settings for the Config 2 */
/* Second Config
* ADC_TC_Config Sample Rate: 60 Samples per Second
* ADC_TC_Config Conversion Mode: 2
* ADC_TC_Config Input Buffer Gain: 1
* ADC_TC_Config Reference: 0
* ADC_TC_Config Input Range: 10
* ADC_TC_Config Resolution: 20 bits
* ADC_TC_Config Clock: 983040 Hz
*/

#define ADC_TC_Config_DEC_CR             (0x78u)
#define ADC_TC_Config_DEC_SR             (0x14u)
#define ADC_TC_Config_DEC_SHIFT1         (0x00u)
#define ADC_TC_Config_DEC_SHIFT2         (0x0Au)
...
#define ADC_TC_Config_DSM_CR5            (0x7Cu)
#define ADC_TC_Config_DSM_CR6            (0x0Cu)
#define ADC_TC_Config_DSM_CR7            (0x20u)
#define ADC_TC_Config_DSM_CR8            (0x5Bu)
#define ADC_TC_Config_DSM_CR9            (0x5Eu)
#define ADC_TC_Config_DSM_CR10           (0x44u)
#define ADC_TC_Config_DSM_CR11           (0x42u)
#define ADC_TC_Config_DSM_CR12           (0x12u)
...
#define ADC_TC_Config_DSM_CR17           (0xEBu)
#define ADC_TC_Config_DSM_REF0           (0x44u)
#define ADC_TC_Config_DSM_REF2           (0x58u)
...
#define ADC_TC_Config_DSM_SW3            (0x00u)
#define ADC_TC_Config_SRATE              (60u )
#define ADC_TC_Config_CLOCKS_PER_SAMPLE  (0x4000u)
#define ADC_TC_Config_CLOCK_FREQ         (983040u)
#define ADC_TC_Config_CP_CLOCK_FREQ      (4000000u)
#define ADC_TC_Config_REFERENCE_VOLTAGE  (1.0240)
#define ADC_TC_Config_COUNTS_PER_VOLT    (8192000)
#define ADC_TC_Config_RESOLUTION         (20u)
#define ADC_TC_Config_CONV_MODE          (2u)
#define ADC_TC_Config_IDEAL_DEC_GAIN     (0x8EE2u)
#define ADC_TC_Config_INPUT_RANGE        (10u)
#define ADC_TC_Config_INPUT_RANGE_VALUE  (0.064)

#define ADC_TC_Config_REFERENCE          (0u)
#define ADC_TC_Config_BUFFER_GAIN        (1u)
#define ADC_TC_Config_ALIGNMENT          (0u)
#define ADC_TC_Config_ADC_CLK_DIVIDER    (23u)
#define ADC_TC_Config_CP_CLK_DIVIDER     (5u)

/* Input and DAC Cap values in pF */
#define ADC_TC_Config_IPCAP1VALUE        (0x4330u)
#define ADC_TC_Config_DACAPVALUE         (0x04B0u)
#define ADC_TC_Config_IDEAL_ODDDEC_GAIN  (0x8000u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_TC_Config_CONVMODE           ADC_TC_Config_CONV_MODE
#define ADC_TC_Config_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
#define ADC_DEFAULT_SRATE_CFG2                 ADC_TC_Config_SRATE
#define ADC_CLOCKS_PER_SAMPLE_CFG2             ADC_TC_Config_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ_CFG2               ADC_TC_Config_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE_CFG2             ADC_TC_Config_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT_CFG2          ADC_TC_Config_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION_CFG2            ADC_TC_Config_RESOLUTION
#define ADC_CONVMODE_CFG2                      ADC_TC_Config_CONVMODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN_CFG2        ADC_TC_Config_IDEAL_DEC_GAIN
#define ADC_DEFAULT_INPUT_RANGE_CFG2           ADC_TC_Config_INPUT_RANGE
#define ADC_DEFAULT_INPUT_RANGE_VALUE_CFG2     ADC_TC_Config_INPUT_RANGE_VALUE
#define ADC_DEFAULT_INPUT_MODE_CFG2            ADC_TC_Config_INPUT_MODE
#define ADC_DEFAULT_REFERENCE_CFG2             ADC_TC_Config_REFERENCE
#define ADC_DEFAULT_BUFFER_GAIN_CONFIG2        ADC_TC_Config_BUFFER_GAIN

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE_CFG2           ADC_TC_Config_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE_CFG2            ADC_TC_Config_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN_CFG2     ADC_TC_Config_IDEAL_ODDDEC_GAIN


/* Default register settings for the following configuration */
/* Third Config
* ADC_Therm_Config Sample Rate: 10000 Samples per Second
* ADC_Therm_Config Conversion Mode: 2
* ADC_Therm_Config Input Buffer Gain: 1
* ADC_Therm_Config Reference: 0
* ADC_Therm_Config Input Range: 4
* ADC_Therm_Config Resolution: 16 bits
* ADC_Therm_Config Clock: 640000 Hz
*/

#define ADC_Therm_Config_DEC_CR             (0x38u)
#define ADC_Therm_Config_DEC_SR             (0x14u)
#define ADC_Therm_Config_DEC_SHIFT1         (0x04u)
#define ADC_Therm_Config_DEC_SHIFT2         (0x07u)
#define ADC_Therm_Config_DEC_DIV            (0)
#define ADC_Therm_Config_DEC_DR2            (0x00u)
#define ADC_Therm_Config_DEC_DR2H           (0x00u)
#define ADC_Therm_Config_DEC_DR1            (0x3Fu)
#define ADC_Therm_Config_DEC_OCOR           (0x00u)
#define ADC_Therm_Config_DEC_OCORM          (0x00u)
#define ADC_Therm_Config_DEC_OCORH          (0x00u)
#define ADC_Therm_Config_DEC_GVAL           (0x0Fu)
#define ADC_Therm_Config_DEC_GCOR           (0x00u)
#define ADC_Therm_Config_DEC_GCORH          (0x00u)
#define ADC_Therm_Config_DEC_COHER          (0x01u)
#define ADC_Therm_Config_DSM_CR0            (0x0Au)
#define ADC_Therm_Config_DSM_CR1            (0x00u)
#define ADC_Therm_Config_DSM_CR2            (0x7Au)
#define ADC_Therm_Config_DSM_CR3            (0x00u)
#define ADC_Therm_Config_DSM_CR4            (0x50u)
#define ADC_Therm_Config_DSM_CR5            (0x27u)
#define ADC_Therm_Config_DSM_CR6            (0x2Cu)
#define ADC_Therm_Config_DSM_CR7            (0x00u)
#define ADC_Therm_Config_DSM_CR8            (0x5Bu)
#define ADC_Therm_Config_DSM_CR9            (0x5Eu)
#define ADC_Therm_Config_DSM_CR10           (0x55u)
#define ADC_Therm_Config_DSM_CR11           (0x5Au)
#define ADC_Therm_Config_DSM_CR12           (0x05u)
#define ADC_Therm_Config_DSM_CR13           (0x00u)
#define ADC_Therm_Config_DSM_CR14           (0x01u)
#define ADC_Therm_Config_DSM_CR15           (0x11u)
#define ADC_Therm_Config_DSM_CR16           (0x19u)
#define ADC_Therm_Config_DSM_CR17           (0x97u)
#define ADC_Therm_Config_DSM_REF0           (0x44u)
#define ADC_Therm_Config_DSM_REF2           (0x58u)
#define ADC_Therm_Config_DSM_REF3           (0x00u)
#define ADC_Therm_Config_DSM_DEM0           (0x04u)
#define ADC_Therm_Config_DSM_DEM1           (0x00u)
#define ADC_Therm_Config_DSM_BUF0           (0x01u)
#define ADC_Therm_Config_DSM_BUF1           (0x01u)
#define ADC_Therm_Config_DSM_BUF2           (0x00u)
#define ADC_Therm_Config_DSM_BUF3           (0x0Au)
#define ADC_Therm_Config_DSM_OUT0           (0x00u)
#define ADC_Therm_Config_DSM_OUT1           (0x00u)
#define ADC_Therm_Config_DSM_SW3            (0x00u)
#define ADC_Therm_Config_SRATE              (10000u)
#define ADC_Therm_Config_CLOCKS_PER_SAMPLE  (0x0040u)
#define ADC_Therm_Config_CLOCK_FREQ         (640000u)
#define ADC_Therm_Config_CP_CLOCK_FREQ      (4000000u)
#define ADC_Therm_Config_REFERENCE_VOLTAGE  (1.0240)
#define ADC_Therm_Config_COUNTS_PER_VOLT    (32000)
#define ADC_Therm_Config_RESOLUTION         (16u)
#define ADC_Therm_Config_CONV_MODE          (2u)
#define ADC_Therm_Config_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_Therm_Config_INPUT_RANGE        (4u)
#define ADC_Therm_Config_REFERENCE          (0u)
#define ADC_Therm_Config_BUFFER_GAIN        (1u)
#define ADC_Therm_Config_INPUT_RANGE_VALUE  (1.024)
#define ADC_Therm_Config_ALIGNMENT          (0u)
#define ADC_Therm_Config_ADC_CLK_DIVIDER    (37u)
#define ADC_Therm_Config_CP_CLK_DIVIDER     (5u)

/* Input and DAC Cap values in pF */
#define ADC_Therm_Config_IPCAP1VALUE        (0x0F30u)
#define ADC_Therm_Config_DACAPVALUE         (0x1130u)
#define ADC_Therm_Config_IDEAL_ODDDEC_GAIN  (0x8000u)

/* Below defines are deprecated and should not be used. These are provided
*   just to keep the component backward compatible
*/
#define ADC_Therm_Config_CONVMODE           ADC_Therm_Config_CONV_MODE
#define ADC_Therm_Config_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
#define ADC_DEFAULT_SRATE_CFG3                 ADC_Therm_Config_SRATE
#define ADC_CLOCKS_PER_SAMPLE_CFG3             ADC_Therm_Config_CLOCKS_PER_SAMPLE
#define ADC_DFLT_CLOCK_FREQ_CFG3               ADC_Therm_Config_CLOCK_FREQ
#define ADC_REFERENCE_VOLTAGE_CFG3             ADC_Therm_Config_REFERENCE_VOLTAGE
#define ADC_DFLT_COUNTS_PER_VOLT_CFG3          ADC_Therm_Config_COUNTS_PER_VOLT
#define ADC_DEFAULT_RESOLUTION_CFG3            ADC_Therm_Config_RESOLUTION
#define ADC_CONVMODE_CFG3                      ADC_Therm_Config_CONVMODE
#define ADC_DEFAULT_IDEAL_DEC_GAIN_CFG3        ADC_Therm_Config_IDEAL_DEC_GAIN
#define ADC_DEFAULT_INPUT_RANGE_CFG3           ADC_Therm_Config_INPUT_RANGE
#define ADC_DEFAULT_INPUT_RANGE_VALUE_CFG3     ADC_Therm_Config_INPUT_RANGE_VALUE
#define ADC_DEFAULT_INPUT_MODE_CFG3            ADC_Therm_Config_INPUT_MODE
#define ADC_DEFAULT_REFERENCE_CFG3             ADC_Therm_Config_REFERENCE
#define ADC_DEFAULT_BUFFER_GAIN_CONFIG3        ADC_Therm_Config_BUFFER_GAIN

/* Input and DAC Cap values in pF */
#define ADC_DEFAULT_IPCAP1VALUE_CFG3           ADC_Therm_Config_IPCAP1VALUE
#define ADC_DEFAULT_DACAPVALUE_CFG3            ADC_Therm_Config_DACAPVALUE
#define ADC_DEFAULT_IDEAL_ODDDEC_GAIN_CFG3     ADC_Therm_Config_IDEAL_ODDDEC_GAIN
