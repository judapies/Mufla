...
#if(CY_PSOC3)
{
    ...
    ***************************************/
    const int32 CYCODE Thermocouple_1_coeffVT[][3] = {{675113, 565925, -13785657},
...
const int8 CYCODE Thermocouple_1_xScaleVT[3] = {12, 14, 15};
const int8 CYCODE Thermocouple_1_coefScaleVT[3] = {15, 13, 11};
