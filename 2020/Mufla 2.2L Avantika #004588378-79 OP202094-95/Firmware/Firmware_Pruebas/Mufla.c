...
#define   Buzz_on          output_bit(PIN_C5,1)
#define   Buzz_off         output_bit(PIN_C5,0)
#define   Vent1_on         output_bit(PIN_C1,0)
#define   Vent1_off        output_bit(PIN_C1,1)
#define   Vent2_on         output_bit(PIN_C2,0)
#define   Vent2_off        output_bit(PIN_C2,1)
...
int8 y=0,tiemporeset=0,Programa=1,Control=0,n=0,l2=0,h2=0;
...
float Potencia=0.0,PotenciaEntregada=0.0,ambiente=0.0;
...
float m1=0,m2=0,b1=0,b2=0,m3=0,b3=0;
int16 control1=0,control2=0,control3=0,patron1=0,patron2=0,patron3=0,calib=1;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      ...
      if(visual==1){
         ...
         */
         ...
         sprintf(Menus.Letra, "%02Lu  m1:%2.2f b1:%2.2f",calib,m1,b1);
         displayMenu(Menus.Letra,0,0,1,1);
